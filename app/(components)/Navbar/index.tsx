        ...
        <div className="flex justify-between items-center gap-5">
            <div className="hidden md:flex justify-between items-center gap-5">
                ...
                <div className="relative rounded-full hover:border hover:border-green-200 hover:bg-blue-100 p-1">
                    <Bell className="cursor-pointer text-gray-500 hover:text-blue-200" size={24} />
                ...
                <div className="flex items-center gap-3 cursor-pointer rounded-full border border-blue-200 p-2 hover:bg-blue-100">
                    <div className="w-10 h-10 rounded-full bg-blue-200 p-1">
